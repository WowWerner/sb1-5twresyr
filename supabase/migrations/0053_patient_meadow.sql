/*
  ...
  2. Create new policies with proper BIM admin access
  3. Update security definer functions
*/

-- Drop existing policies
DROP POLICY IF EXISTS "investor_users_read" ON investor_users;
DROP POLICY IF EXISTS "investor_users_write" ON investor_users;
DROP POLICY IF EXISTS "investor_users_modify" ON investor_users;
DROP POLICY IF EXISTS "investor_users_remove" ON investor_users;
...
DROP POLICY IF EXISTS "investor_profiles_remove" ON investor_profiles;
...
-- Create helper function for investor creation
